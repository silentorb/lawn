...
SessionStore.prototype.get = function(session_id, cb) {
  ...
  var sql = 'SELECT `data` FROM `express_sessions` WHERE `session_id` = ? LIMIT 1'
  var params = [ session_id ]

  this.db.query(sql, params).done(function(rows) {
...
SessionStore.prototype.set = function(session_id, data, cb) {
  ...
  var sql = 'REPLACE INTO `express_sessions` SET ?'
...
SessionStore.prototype.destroy = function(session_id, cb) {
  ...
  var sql = 'DELETE FROM `express_sessions` WHERE `session_id` = ? LIMIT 1'
  var params = [ session_id ]
...
SessionStore.prototype.length = function(cb) {
  ...
  var sql = 'SELECT COUNT(*) FROM `express_sessions`'
...
SessionStore.prototype.clear = function(cb) {
  ...
  var sql = 'DELETE FROM `express_sessions`'
...
SessionStore.prototype.clearExpiredSessions = function(cb) {
  ...
  var sql = 'DELETE FROM `express_sessions` WHERE `expires` < ?'
